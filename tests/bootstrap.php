<?php
/**
 * Resize_Animated_GIF Test Bootstrapper.
 *
 * @since   1.0.0
 ...
 * @since 1.0.0
 */
function _manually_load_resize_animated_gif_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/resize-animated-gif.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_resize_animated_gif_plugin' );
